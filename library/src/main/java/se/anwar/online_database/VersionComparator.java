...
class VersionComparator implements Comparator<String> {
     ...
     * @throws SQLiteOnlineHelper.SQLiteOnlineException thrown if the strings are not in the correct upgrade
     *                                                  script format of:
    ...
    public int compare(String file0, String file1) {
        ...
        if (!m0.matches()) {
            ...
            throw new SQLiteOnlineHelper.SQLiteOnlineException("Invalid upgrade script file");
        }
        ...
        int v0_from = Integer.parseInt(m0.group(1));
        int v1_from = Integer.parseInt(m1.group(1));
        int v0_to = Integer.parseInt(m0.group(2));
        int v1_to = Integer.parseInt(m1.group(2));
